...
var ApplePay = {
     ...
     * @returns {Promise}
     */
    setPublishableKey: function(publishableKey, successCallback, errorCallback) {
        return new Promise(function(resolve, reject) {
            exec(function(message) {
                ...
                reject(message);
            }, 'ApplePay', 'setPublishableKey', [publishableKey]);
        });
    },
   ...
   setMerchantId: function(merchantId, successCallback, errorCallback) {
       return new Promise(function(resolve, reject) {
           exec(function(message) {
               ...
               executeCallback(errorCallback, message);
               reject(message);
           }, 'ApplePay', 'setMerchantId', [merchantId]);
       });
   },
